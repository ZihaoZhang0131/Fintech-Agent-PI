...
const runtimeHome = process.env.KAMI_RUNTIME_DIR;
const cacheHome = process.platform === "darwin"
  ? path.join(os.homedir(), ".cache")
  : (process.env.XDG_CACHE_HOME || path.join(os.homedir(), ".cache"));
const mathRoot = runtimeHome
  ? path.join(runtimeHome, "mathjax", mathJaxVersion)
  : path.join(cacheHome, "kami", "mathjax", mathJaxVersion);
