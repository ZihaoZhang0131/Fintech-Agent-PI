...
### index_stock_cons
- **文档定位**：中国股票指数成份 / 最新成份
- **HTTP**：`GET /api/public/index_stock_cons`
- **调用**：运行 `scripts/aktools_get.py index_stock_cons --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：中国股票指数成份 / 中证指数成份股
- **HTTP**：`GET /api/public/index_stock_cons_csindex`
- **调用**：运行 `scripts/aktools_get.py index_stock_cons_csindex --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：中国股票指数成份 / 中证指数成份股权重
- **HTTP**：`GET /api/public/index_stock_cons_weight_csindex`
- **调用**：运行 `scripts/aktools_get.py index_stock_cons_weight_csindex --param key=value`；参数以本卡的输入参数表为准。
...
### index_sugar_msweet
- **文档定位**：中国食糖指数
- **HTTP**：`GET /api/public/index_sugar_msweet`
- **调用**：运行 `scripts/aktools_get.py index_sugar_msweet --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：中证指数
- **HTTP**：`GET /api/public/stock_zh_index_hist_csindex`
- **调用**：运行 `scripts/aktools_get.py stock_zh_index_hist_csindex --param key=value`；参数以本卡的输入参数表为准。
...
### index_yw
- **文档定位**：义乌小商品指数
- **HTTP**：`GET /api/public/index_yw`
- **调用**：运行 `scripts/aktools_get.py index_yw --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：全球指数 / 全球指数-实时行情数据
- **HTTP**：`GET /api/public/index_global_spot_em`
- **调用**：运行 `scripts/aktools_get.py index_global_spot_em --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：全球指数 / 全球指数-历史行情数据-东财
- **HTTP**：`GET /api/public/index_global_hist_em`
- **调用**：运行 `scripts/aktools_get.py index_global_hist_em --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：全球指数 / 全球指数-历史行情数据-新浪
- **HTTP**：`GET /api/public/index_global_hist_sina`
- **调用**：运行 `scripts/aktools_get.py index_global_hist_sina --param key=value`；参数以本卡的输入参数表为准。
...
### index_price_cflp
- **文档定位**：公路物流指数 / 中国公路物流运价指数
- **HTTP**：`GET /api/public/index_price_cflp`
- **调用**：运行 `scripts/aktools_get.py index_price_cflp --param key=value`；参数以本卡的输入参数表为准。
...
### index_volume_cflp
- **文档定位**：公路物流指数 / 中国公路物流运量指数
- **HTTP**：`GET /api/public/index_volume_cflp`
- **调用**：运行 `scripts/aktools_get.py index_volume_cflp --param key=value`；参数以本卡的输入参数表为准。
...
### spot_goods
- **文档定位**：商品现货价格指数
- **HTTP**：`GET /api/public/spot_goods`
- **调用**：运行 `scripts/aktools_get.py spot_goods --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：市场情绪指数 / A 股新闻情绪指数
- **HTTP**：`GET /api/public/index_news_sentiment_scope`
- **调用**：运行 `scripts/aktools_get.py index_news_sentiment_scope --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：指数估值 / 指数估值-中证
- **HTTP**：`GET /api/public/stock_zh_index_value_csindex`
- **调用**：运行 `scripts/aktools_get.py stock_zh_index_value_csindex --param key=value`；参数以本卡的输入参数表为准。
...
### index_eri
- **文档定位**：排污权指数
- **HTTP**：`GET /api/public/index_eri`
- **调用**：运行 `scripts/aktools_get.py index_eri --param key=value`；参数以本卡的输入参数表为准。
...
### index_kq_fashion
- **文档定位**：柯桥时尚指数
- **HTTP**：`GET /api/public/index_kq_fashion`
- **调用**：运行 `scripts/aktools_get.py index_kq_fashion --param key=value`；参数以本卡的输入参数表为准。
...
### index_kq_fz
- **文档定位**：柯桥纺织品指数
- **HTTP**：`GET /api/public/index_kq_fz`
- **调用**：运行 `scripts/aktools_get.py index_kq_fz --param key=value`；参数以本卡的输入参数表为准。
...
### sw_index_first_info
- **文档定位**：申万一级行业信息
- **HTTP**：`GET /api/public/sw_index_first_info`
- **调用**：运行 `scripts/aktools_get.py sw_index_first_info --param key=value`；参数以本卡的输入参数表为准。
...
### sw_index_third_info
- **文档定位**：申万三级行业信息
- **HTTP**：`GET /api/public/sw_index_third_info`
- **调用**：运行 `scripts/aktools_get.py sw_index_third_info --param key=value`；参数以本卡的输入参数表为准。
...
### sw_index_third_cons
- **文档定位**：申万三级行业成份
- **HTTP**：`GET /api/public/sw_index_third_cons`
- **调用**：运行 `scripts/aktools_get.py sw_index_third_cons --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：申万二级行业信息
- **HTTP**：`GET /api/public/sw_index_second_info`
- **调用**：运行 `scripts/aktools_get.py sw_index_second_info --param key=value`；参数以本卡的输入参数表为准。
...
### index_us_stock_sina
- **文档定位**：美股股票指数 / 指数行情
- **HTTP**：`GET /api/public/index_us_stock_sina`
- **调用**：运行 `scripts/aktools_get.py index_us_stock_sina --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：配额内进口糖估算指数
- **HTTP**：`GET /api/public/index_inner_quote_sugar_msweet`
- **调用**：运行 `scripts/aktools_get.py index_inner_quote_sugar_msweet --param key=value`；参数以本卡的输入参数表为准。
...
- **文档定位**：配额外进口糖估算指数
- **HTTP**：`GET /api/public/index_outer_quote_sugar_msweet`
- **调用**：运行 `scripts/aktools_get.py index_outer_quote_sugar_msweet --param key=value`；参数以本卡的输入参数表为准。
...
### drewry_wci_index
- **文档定位**：集装箱指数
- **HTTP**：`GET /api/public/drewry_wci_index`
- **调用**：运行 `scripts/aktools_get.py drewry_wci_index --param key=value`；参数以本卡的输入参数表为准。
