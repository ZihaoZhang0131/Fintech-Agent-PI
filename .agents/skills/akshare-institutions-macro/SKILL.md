---
name: akshare-institutions-macro
description: 当用户需要通过本机 AKTools HTTP 服务查询 LME、CFTC、CME、SPDR 黄金 ETF、白银 ETF 或 OPEC 的库存、持仓和月度报告时使用。仅使用已验证可用的重要机构 AKShare 接口。
---

# AKShare 重要机构数据

通过本机 AKTools HTTP 服务查询已验证可用的 LME、CFTC、CME、ETF 与 OPEC 数据。
